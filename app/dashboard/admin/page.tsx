            ...
            <tbody>
              {profiles.map((p: any, i: number) => (
                ...
                >
                  ...
                  <td style={{ padding: '14px 16px' }}>{p.team ? <span style={{ padding: '3px 10px', borderRadius: 4, fontSize: 11, fontWeight: 600, background: `${TEAM_COLORS[p.team]}22`, color: TEAM_COLORS[p.team] }}>{p.team}</span> : <span style={{ color: 'var(--muted)' }}>—</span>}</td>
              ...
              <tbody>
                {pending.map((inv: any, i: number) => (
                  ...
                  >
                    ...
                    <td style={{ padding: '14px 16px' }}>{inv.team && <span style={{ padding: '3px 10px', borderRadius: 4, fontSize: 11, fontWeight: 600, background: `${TEAM_COLORS[inv.team]}22`, color: TEAM_COLORS[inv.team] }}>{inv.team}</span>}</td>
